...
//	protected Object uuid;
    ...
    public class DateValidationException extends Exception{
     ...
     public class EmployeeAttendance extends Employee  implements  Display {
	...
	public static boolean isValidDate(String datestr ) throws DateValidationException {
		...
		catch(DateValidationException pe){
			pe.printStackTrace();
			return false;
		}
		finally {
